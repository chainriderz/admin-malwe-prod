  ...
  <div class="d-xl-flex">
      <div class="w-100">
          <div class="d-md-flex">
              ...
              <div class="card filemanager-sidebar mr-md-2 mb-4">
                  <div class="card-body">
                              ...
                              <ul class="list-unstyled categories-list">
                                                    ...
                                                    ?>
                                                      <li>
                                                          <a href="<?php echo $folder; ?>" target="_blank" class="text-dark d-flex align-items-center">
                                                              <i class="fa fa-image text-primary font-size-16 mr-2"></i> <span class="mr-auto"><?php echo $value; ?></span>
                                                          </a>
                                                      </li>
                                                    <?php
                                                          }
                                  ...
                                  <li>
                                      <a href="javascript: void(0);" class="text-body d-flex align-items-center">
                                          <i class="fa fa-share-alt font-size-16 mr-2"></i> <span class="mr-auto">Shared</span> <i class="fa fa-circle-medium text-danger ml-2"></i>
                                      </a>
                                  </li>
                              </ul>
                          </div>
