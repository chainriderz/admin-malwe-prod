...
<div class="content">
	<div class="container-fluid">
		<h4 class="page-title">Upcoming Expiry Data</h4>
		<div class="row">
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-header font-weight-bold text-uppercase">UPCOMING EXPIRY DETAILS</div>
					<div class="card-body">
						<div class="table-responsive">
							<table id="RegisteredDataTable" class="table table-bordered">
								<thead class="thead-light">
									<tr>
									    <th rowspan="2">Sr. No.</th>
									    <th rowspan="2">Days Remain</th>
								...
								<tbody>
									<?php
										$select_reg = "SELECT *, DATEDIFF(`agreement_end_date`, CURDATE()) AS `date_diff` FROM `registered_document` WHERE `record_status` = 'Active' HAVING date_diff <=30 AND date_diff > 0 ORDER BY `date_diff` ASC, FIELD(`record_status`, 'Active', 'Inactive'), `agreement_end_date` ASC";
						...
						<tr>
							...
							<td>
								<div class="mb-2 text-left">
									<a href="<?=$_SERVER['host_name'];?>/malwe.online/Staff/PDF/<?php echo $folder.'/'.$upload_1; ?>" target="_blank"><?php echo $upload_1; ?></a>
								</div>

								<div class="mb-2 text-left">
									<a href="<?=$_SERVER['host_name'];?>/malwe.online/Staff/PDF/<?php echo $folder.'/'.$upload_2; ?>" target="_blank"><?php echo $upload_2; ?></a>
								</div>

								<div class="mb-2 text-left">
									<a href="<?=$_SERVER['host_name'];?>/malwe.online/Staff/PDF/<?php echo $folder.'/'.$upload_3; ?>" target="_blank"><?php echo $upload_3; ?></a>
								</div>

								<div class="mb-2 text-left">
									<a href="<?=$_SERVER['host_name'];?>/malwe.online/Staff/PDF/<?php echo $folder.'/'.$upload_4; ?>" target="_blank"><?php echo $upload_4; ?></a>
								</div>

								<div class="mb-2 text-left">
									<a href="<?=$_SERVER['host_name'];?>/malwe.online/Staff/PDF/<?php echo $folder.'/'.$upload_5; ?>" target="_blank"><?php echo $upload_5; ?></a>
								</div>
							</td>
						</tr>
						<tr>
...
<script type="text/javascript">
	$(".sidebar .nav .registered_document_expiry").addClass("active");
</script>