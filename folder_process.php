...
//   listFolder('../Documents', 'website.jpg');
  
if(isset($_GET['folder']))
{
	$dir = $_GET['folder'];

	$files_fetch2 = scandir($dir);
    $files_fetch2 = array_diff(scandir($dir), array('.', '..'));
//   print_r($dir);
      ...
      echo 
	    ...
	    foreach ($files_fetch2 as $key => $value)
	    {
	      	$path = $dir.$value;
	      	// echo $path."<br>";
	      	// print_r($files_fetch2);
	      	...
	      	if(is_file($path))
    		{
	                      ...
	                      <td>
	                          <div class="dropdown">
	                              ...
	                              <div class="dropdown-menu dropdown-menu-end">
	                                  ...
	                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#shareModal_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'">Share</a>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                      ...
                                      <!-- Modal body -->
					                            <div class="modal-body">
					                              <input type="hidden" class="form-control" name="source" id="source_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'" value="'.$path.'">
                                ...
                                <div class="modal fade moveModal" id="moveModal_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'">
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                      ...
                                      <!-- Modal body -->
					                            <div class="modal-body">
					                              <input type="hidden" class="form-control" name="source" id="msource_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'" value="'.$path.'">
					                              <label>Select Path</label>
					                              <div class="input-group mb-3">
					                                ';                                              
                                ...
                                <div class="modal fade shareModal" id="shareModal_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'">
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <!-- Modal body -->
                            <div class="modal-body">
                              <input type="hidden" name="filename" id="filename_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'" value="http://malwe.online/'.str_replace('../', '', $path).'" required>
                              <div class="input-group mb-3">
                                <input type="email" name="email" id="email_'.str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME)).'" class="form-control" placeholder="Enter Email" required>
                                <div class="input-group-append">
                                  <button type="button" class="btn btn-success submit_share"
                                  onclick="ShareFunction($('."'#email_".str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME))."'".').val(), $('."'#filename_".str_replace(array(' ', '(', ')', '-'), array('_', '', '', ''), pathinfo($path, PATHINFO_FILENAME))."'".').val());">
	      		...
	      		elseif (pathinfo($path, PATHINFO_EXTENSION) == 'doc' ||
	      		...
	      		elseif (pathinfo($path, PATHINFO_EXTENSION) == 'xls' ||
	      			pathinfo($path, PATHINFO_EXTENSION) == 'xlsx')
	      		{
	      			echo '			      
	                  <tr>
	                      <td>
